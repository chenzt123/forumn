...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../resource/layui/lay/modules/upload.js"/>
</head>
            ...
            <div class="ibox float-e-margins l_ibox">
                ...
                <form class="layui-form" action="../informationContent/saveOrUpdate" method="post" id="editForm">
                    <div class="l_three clearfix">
                        <div class="layui-form-item">
                            ...
                            <div class="layui-input-block">
                                <input type="text" name="topicTitle" maxlength="10" lay-verify="required"  autocomplete="off" placeholder="请输入标题(必填项)"  class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item">
                            <label class="layui-form-label">关联期号：</label>
                            <div class="layui-input-block">
                                <input type="text" name="drawId" lay-verify="required" autocomplete="off" placeholder="关联期号(必填项)"  maxlength="10" class="layui-input">
                            </div>
                        </div>
                            ...
                            <div class="layui-input-block">
                                <select  name="relativeModIt"  lay-filter="aihao">
                                    <c:forEach items="${forumnTopicModels}" var="forumnTopicModel" begin="0" step="1" varStatus="star">
                                        <option id="relativeModIt"  name="relativeModIt" value="${forumnTopicModel.modelId}">${forumnTopicModel.modelTitle}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <script id="topicContent" name="topicContent" type="text">${content.contContent}</script>
                        </div>
                    </div>
                    </div>
                    <div class="l_three clearfix">
...
<script>
    $(document).ready(function (){
        var ueditor=UE.getEditor("topicContent",{
